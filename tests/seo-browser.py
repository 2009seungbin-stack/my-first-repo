...
def run_mode(browser,mode,index):
    ...
    try:
        ...
        page.locator('[data-action="task-sample"]').click();page.wait_for_function(READY,timeout=120000)
        ...
        page.locator('#upMode [data-mode="pixel"]').click();page.locator('#languageSelect').select_option('ja');idle(page)
        ok(mode+' pending edit state retained',page.locator('#upMode [data-mode="pixel"]').get_attribute('aria-pressed')=='true')
