...
with sync_playwright() as pw:
 ...
 page=mount(en,'/en/image/editor/');page.keyboard.press('Control+k');page.locator('#toolSearch').fill('upscale');click(page,'kit-open:upscale');ok('catalog keeps the existing upscale workflow',page.locator('#emptyTitle').inner_text()=='Make your image bigger');page.close()
