...
with sync_playwright() as pw:
    ...
    click(page,'kit-close');ok('unqualified tools are excluded from featured promotion',page.locator('#featuredIntents a').evaluate_all('ns=>ns.map(n=>n.dataset.action)')==['intent:compress'])
