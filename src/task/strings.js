...
const S={
 ko:{gh:{footerLine:'브라우저에서 쓰는 2D 게임 에셋 스튜디오. 파일은 기기 밖으로 나가지 않습니다.',navWorkflow:'작업 흐름',navEngines:'엔진',navTools:'게임 도구',dropOr:'또는 스프라이트 시트·프레임·GIF·.aseprite·타일셋 파일을 이 페이지 아무 곳에나 놓으세요',dragTitle:'놓으면 스튜디오에서 열립니다',shotCaption:'실제 스튜디오 화면: GrafxKid의 “Classic Hero”(CC0)를 태그된 애니메이션 5개로 자르고 피벗·허트박스·히트박스를 지정했습니다.',flow:{kicker:'작업 흐름',title:'스프라이트 시트부터 엔진까지, 스튜디오 하나로',lead:'작업 공간마다 파이프라인의 한 단계를 맡고 결과를 다음 단계로 넘깁니다. 모든 처리는 이 브라우저 탭 안에서 이루어집니다.',sprite:['시트를 태그된 애니메이션으로','시트, 번호 붙은 프레임, GIF, .aseprite 파일을 놓으세요. 격자는 신뢰도와 함께 감지되며 언제든 바꿀 수 있고, 태그·타이밍·피벗·히트박스·허트박스는 실제 타임라인에서 편집합니다.'],pack:['아틀라스 패킹과 엔진별 내보내기','트림·회전·여백·익스트루드·멀티팩을 지원하는 MaxRects 패킹. 클릭 한 번으로 엔진마다 필요한 파일을 만들고, 어떤 내보내기를 실제 엔진에서 다시 불러와 확인했는지는 아래 엔진 목록에 적어 두었습니다.'],tile:['엔진과 똑같이 칠해지는 오토타일','47타일 블롭이나 Wang 시트의 배치를 픽셀에서 인식해 지형 비트를 채우고, Godot 4와 같은 규칙으로 테스트 맵을 칠해 봅니다.'],pixel:['도트를 그리고 확대된 도트를 1배로','에이스프라이트 키로 쓰는 연필·페인트통·선택·레이어, 인덱스 팔레트와 Lospec, 어니언 스킨. 확대되거나 크기가 바뀐 도트는 픽셀 크기를 재서 1픽셀 = 1픽셀로 되돌립니다.'],labs:['픽셀·텍스처·UI 랩 도구','스튜디오 옆의 단일 작업 도구: 프레임 팔레트 고정과 램프, 텍스처 채널 패킹과 PBR 점검, 9-slice 패널과 비트맵 폰트. UI는 스튜디오 작업 공간이 완성될 때까지 Lab 도구로 제공합니다.'],openPixel:'픽셀 작업 공간 열기',pixelCaption:'실제 픽셀 작업 공간: DezrasDragons의 CC0 닌자 달리기 6프레임, 어니언 스킨을 켜고 3번 프레임을 연 화면.',openSprite:'스프라이트 작업 공간 열기',openPack:'패킹·내보내기 열기',openTile:'타일 작업 공간 열기',demo:'GrafxKid의 “Classic Hero”(CC0)로 만든 데모: 시트를 태그된 줄 5개로 자르고 걷기 줄을 10fps로 재생합니다.',sheet:'시트',preview:'미리보기',packCaption:'실제 패킹·내보내기 화면: 같은 프레임 26개를 트림해 패킹했고, Godot 4용으로 바로 내보낼 수 있습니다.',tileCaption:'실제 타일 작업 공간: CC0 동굴 타일셋을 47타일 배치로 인식하고 Godot 4 규칙으로 테스트 맵을 칠했습니다.'},status:{verified:'검증됨',built:'빌드 확인',partial:'일부 검증',unverified:'미검증'},toolsLead:'게임 도구마다 전용 페이지가 있습니다. 검색하거나 전체 목록을 펼쳐 보세요.',moreTools:'게임 도구 모두 보기',hubLinks:'엔진·형식·문제별로 찾기',hubEngines:'엔진별 가이드',hubFormats:'형식 변환',hubFixes:'자주 생기는 문제 해결',hubCompare:'다른 도구와 비교',hubAll:'게임 페이지 전체',heroAlt:'Nerulio 스튜디오의 스프라이트 작업 공간: 타임라인, 애니메이션 태그, 피벗과 히트박스',openStudio:'스튜디오 열기',kicker:'무료 · 브라우저에서 실행 · 업로드 없음',workspaces:'스튜디오 작업 공간',ready:'사용 가능',lab:'Lab 도구',engines:'실제 엔진에서 확인한 내보내기',enginesNote:'내보낸 결과를 각 엔진에 실제로 불러와 필드와 픽셀을 비교했습니다. GameMaker와 LDtk는 형식 검사까지만 했습니다.',tools:'게임 도구 하나씩 쓰기',fileTools:'기타 파일 도구',fileToolsLead:'이미지·PDF·영상 도구는 부가 기능으로 계속 제공합니다.',opening:'스튜디오를 여는 중…',studioLink:'스튜디오',fileToolsLink:'파일 도구',ws:{sprite:['스프라이트','시트 자르기, 애니메이션 태그, 피벗·히트박스·충돌'],pack:['패킹·내보내기','트림·회전·멀티팩 아틀라스, 엔진별 원클릭 내보내기'],tile:['타일','오토타일 배치 인식, 지형 비트, 47타일 생성, Godot처럼 테스트'],pixel:['픽셀','팔레트·램프·도트 정리'],texture:['텍스처','노멀맵·채널 패킹·PBR 검사'],ui:['UI·폰트','9-slice·버튼 상태·비트맵 폰트']}},homeTitle:'브라우저에서 바로 쓰는 게임 에셋 스튜디오',homeLead:'Nerulio는 무료 게임 에셋 스튜디오입니다. 스프라이트 시트 자르기, 애니메이션, 아틀라스 패킹, 오토타일 타일셋까지 — Godot·Unity·Phaser 등으로 바로 내보냅니다. 설치도 업로드도 없습니다.',dropTitle:'스프라이트 시트·프레임·GIF·.aseprite·타일셋을 놓으세요',dropHint:'스튜디오에서 바로 열립니다 · PNG · GIF · APNG · .aseprite · JSON 아틀라스',pick:'파일 선택',search:'게임 도구 검색 — 예: 스프라이트 시트, 오토타일, 노멀맵',searchLabel:'도구 검색',noResult:'맞는 도구가 없습니다. 다른 말로 찾아보세요.',
 ...
 en:{gh:{footerLine:'A 2D game asset studio in the browser. Files stay on your device.',navWorkflow:'Workflow',navEngines:'Engines',navTools:'Game tools',dropOr:'or drop a sprite sheet, frames, a GIF, an .aseprite file or a tileset anywhere on this page',dragTitle:'Drop to open in the Studio',shotCaption:'The real Studio: “Classic Hero” by GrafxKid (CC0) cut into five tagged animations, with a pivot, a hurt box and a hit box.',flow:{kicker:'Workflow',title:'From sprite sheet to engine, in one studio',lead:'Each workspace does one part of the pipeline and hands its result to the next. Everything runs in this browser tab.',sprite:['Cut sheets into tagged animations','Drop a sheet, numbered frames, a GIF or an .aseprite file. The grid is detected with a confidence you can overrule; tags, timing, pivots, hit and hurt boxes are edited on a real timeline.'],pack:['Pack atlases and export for each engine','MaxRects packing with trim, rotation, padding, extrusion and multipack. One click writes the files each engine expects; the engine list below says which exports were loaded back in the real engine.'],tile:['Autotiles that paint like the engine','The layout of a 47-tile blob or Wang sheet is recognised from the pixels, terrain bits are filled in, and a test map is painted with the same rule Godot 4 uses.'],pixel:['Draw pixel art, and undo upscales','Pencil, bucket, selections and layers on Aseprite keys, indexed palettes and Lospec, onion skin. Upscaled or resized pixel art is measured and turned back into one pixel per pixel.'],labs:['Pixel, texture and UI Labs','Single-purpose tools next to the Studio: frame palette locking and ramps, texture channel packing and PBR checks, 9-slice panels and bitmap fonts. UI runs as a Lab until its Studio workspace is built.'],openPixel:'Open the Pixel workspace',pixelCaption:'The real Pixel workspace: six CC0 ninja run frames by DezrasDragons, frame 3 open with onion skin.',openSprite:'Open the Sprite workspace',openPack:'Open Pack & Export',openTile:'Open the Tile workspace',demo:'Live demo with “Classic Hero” by GrafxKid (CC0): the sheet cut into five tagged rows, and the walk row played at 10 fps.',sheet:'Sheet',preview:'Preview',packCaption:'The real Pack & Export workspace: the same 26 frames trimmed and packed, ready to export for Godot 4.',tileCaption:'The real Tile workspace: a CC0 cave tileset recognised as a 47-tile layout, and a test map painted with the Godot 4 rule.'},status:{verified:'Verified',built:'Built',partial:'Partly verified',unverified:'UNVERIFIED'},toolsLead:'Every game tool also has its own page. Search, or open the full list.',moreTools:'Show all game tools',hubLinks:'Browse by engine, format and problem',hubEngines:'Engine how-tos',hubFormats:'Format conversions',hubFixes:'Fix common problems',hubCompare:'Compared with other tools',hubAll:'Every game page',heroAlt:'The Nerulio Studio sprite workspace: timeline, animation tags, pivot and hitboxes',openStudio:'Open the Studio',kicker:'Free · runs in your browser · nothing uploaded',workspaces:'Studio workspaces',ready:'Ready',lab:'Lab tool',engines:'Exports tested in the real engines',enginesNote:'Every export is loaded back into the engine and compared field by field and pixel by pixel. GameMaker and LDtk: format checks only.',tools:'Single game tools',fileTools:'Other file tools',fileToolsLead:'Image, PDF and video tools are still here as extras.',opening:'Opening the Studio…',studioLink:'Studio',fileToolsLink:'File tools',ws:{sprite:['Sprite','Slice sheets, tag animations, pivots, hitboxes and collision'],pack:['Pack & Export','Trimmed, rotated, multipack atlases — one click per engine'],tile:['Tile','Detect autotile layouts, paint terrain bits, generate 47-tile sets, test like Godot'],pixel:['Pixel','Palettes, ramps and pixel cleanup'],texture:['Texture','Normal maps, channel packing, PBR checks'],ui:['UI & fonts','9-slice, button states, bitmap fonts']}},homeTitle:'Game asset studio in your browser',homeLead:'Nerulio is a free game asset studio: slice sprite sheets, build animations, pack atlases and generate autotile tilesets — exported for Godot, Unity, Phaser and more. No install, nothing uploaded.',dropTitle:'Drop a sprite sheet, frames, GIF, .aseprite or tileset',dropHint:'It opens straight in the Studio · PNG · GIF · APNG · .aseprite · JSON atlas',pick:'Choose files',search:'Search game tools — e.g. sprite sheet, autotile, normal map',searchLabel:'Search tools',noResult:'No matching tool. Try different words.',
 ...
 ja:{gh:{footerLine:'ブラウザで使う2Dゲームアセットスタジオ。ファイルは端末の外に出ません。',navWorkflow:'ワークフロー',navEngines:'エンジン',navTools:'ゲームツール',dropOr:'またはスプライトシート・フレーム・GIF・.aseprite・タイルセットをこのページのどこにでもドロップ',dragTitle:'ドロップするとスタジオで開きます',shotCaption:'実際のスタジオ画面：GrafxKidの「Classic Hero」（CC0）をタグ付きアニメーション5つに分け、ピボット・ハートボックス・ヒットボックスを設定しています。',flow:{kicker:'ワークフロー',title:'スプライトシートからエンジンまで、ひとつのスタジオで',lead:'ワークスペースごとにパイプラインの一工程を担当し、結果を次へ渡します。処理はすべてこのブラウザのタブの中で行われます。',sprite:['シートをタグ付きアニメーションに','シート、連番フレーム、GIF、.asepriteファイルをドロップ。グリッドは信頼度つきで検出され、いつでも変更できます。タグ・タイミング・ピボット・ヒット／ハートボックスは実際のタイムラインで編集します。'],pack:['アトラスをパックしてエンジン別に書き出し','トリム・回転・余白・押し出し・マルチパック対応のMaxRectsパッキング。ワンクリックで各エンジンが読むファイルを書き出します。実際のエンジンで読み戻して確認した書き出しは、下のエンジン一覧に記載しています。'],tile:['エンジンと同じに塗れるオートタイル','47タイルのブロブやWangシートの配置をピクセルから判別して地形ビットを埋め、Godot 4と同じルールでテストマップを塗って確認します。'],pixel:['ドット絵を描き、拡大されたドット絵を1倍に','Asepriteのキーで使う鉛筆・バケツ・選択・レイヤー、インデックスパレットとLospec、オニオンスキン。拡大・サイズ変更されたドット絵はドットの大きさを測り、1ドット＝1ピクセルに戻します。'],labs:['ピクセル・テクスチャ・UIのLabツール','スタジオの横にある単機能ツール：フレームのパレット固定とランプ、テクスチャのチャンネルパックとPBRチェック、9スライスのパネルとビットマップフォント。UIはスタジオのワークスペースが完成するまでLabツールとして提供します。'],openPixel:'ピクセル作業画面を開く',pixelCaption:'実際のピクセル作業画面：DezrasDragonsのCC0忍者の走り6フレーム。オニオンスキンをオンにして3フレーム目を開いています。',openSprite:'スプライト作業画面を開く',openPack:'パック＆書き出しを開く',openTile:'タイル作業画面を開く',demo:'GrafxKidの「Classic Hero」（CC0）によるデモ：シートをタグ付きの5行に分け、歩き行を10fpsで再生しています。',sheet:'シート',preview:'プレビュー',packCaption:'実際のパック＆書き出し画面：同じ26フレームをトリムしてパックし、Godot 4向けにそのまま書き出せます。',tileCaption:'実際のタイル作業画面：CC0の洞窟タイルセットを47タイル配置と判別し、Godot 4のルールでテストマップを塗っています。'},status:{verified:'検証済み',built:'ビルド確認',partial:'一部検証',unverified:'未検証'},toolsLead:'ゲームツールはそれぞれ専用ページがあります。検索するか、一覧を開いてください。',moreTools:'すべてのゲームツールを表示',hubLinks:'エンジン・形式・問題から探す',hubEngines:'エンジン別の手順',hubFormats:'形式の変換',hubFixes:'よくある問題の解決',hubCompare:'ほかのツールとの比較',hubAll:'ゲームページ一覧',heroAlt:'Nerulioスタジオのスプライト作業画面: タイムライン、アニメーションタグ、ピボットと当たり判定',openStudio:'スタジオを開く',kicker:'無料 · ブラウザで動作 · アップロードなし',workspaces:'スタジオのワークスペース',ready:'利用可能',lab:'Labツール',engines:'実際のエンジンで確認した書き出し',enginesNote:'書き出した結果を各エンジンで実際に読み込み、項目とピクセルを比較しています。GameMakerとLDtkは形式チェックのみです。',tools:'ゲームツールを単体で使う',fileTools:'その他のファイルツール',fileToolsLead:'画像・PDF・動画のツールも引き続き利用できます。',opening:'スタジオを開いています…',studioLink:'スタジオ',fileToolsLink:'ファイルツール',ws:{sprite:['スプライト','シート分割、アニメーションタグ、ピボット・当たり判定・コリジョン'],pack:['パック・書き出し','トリム・回転・マルチパックのアトラス、エンジン別ワンクリック書き出し'],tile:['タイル','オートタイル配置の判別、地形ビット、47タイル生成、Godotと同じテスト'],pixel:['ピクセル','パレット・ランプ・ドット整理'],texture:['テクスチャ','ノーマルマップ・チャンネルパック・PBRチェック'],ui:['UI・フォント','9スライス・ボタン状態・ビットマップフォント']}},homeTitle:'ブラウザで使えるゲーム素材スタジオ',homeLead:'Nerulioは無料のゲーム素材スタジオです。スプライトシートの分割、アニメーション、アトラスのパッキング、オートタイルのタイルセットまで — Godot・Unity・Phaserなどへそのまま書き出せます。インストールもアップロードも不要です。',dropTitle:'スプライトシート・フレーム・GIF・.aseprite・タイルセットをドロップ',dropHint:'スタジオでそのまま開きます · PNG · GIF · APNG · .aseprite · JSONアトラス',pick:'ファイルを選択',search:'ゲームツールを検索 — 例: スプライトシート, オートタイル, ノーマルマップ',searchLabel:'ツールを検索',noResult:'該当するツールがありません。別の言葉でお試しください。',
