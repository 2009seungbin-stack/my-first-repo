...
export function homePage({locale,prefix,base,headHTML,contentHTML}){
 ...
 const hero=`<section class="gh-hero" aria-labelledby="taskTitle"><div class="gs-wrap"><div class="gh-hero-copy">${u('gh.kicker','p','gs-kicker gh-kicker')}<h1 id="taskTitle">${esc(ui(locale,'homeTitle'))}</h1><p class="page-lead" id="taskLead">${esc(description)}</p>
...
<article class="gh-row gh-row-labs" id="flow-labs"><div class="gh-row-copy"><h3>${u('gh.flow.labs.0')}</h3><p>${u('gh.flow.labs.1')}</p></div><div class="gh-labs">${labs}</div></article></div></section>`;
 ...
 const groupName=g=>g==='more'?u('gh.moreTools','h3'):`<h3><span data-ui="gh.ws.${g}.0">${esc(ui(locale,`gh.ws.${g}.0`))}</span></h3>`;
 // The page families (engine how-tos, format conversions, fixes, comparisons) live on the /game/ hub;
