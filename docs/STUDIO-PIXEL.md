...
* `node --test tests/studio-pixel.test.mjs` — 33 tests: raster, strokes, inks, indexed, PNG-8,
...
* `tests/studio-pixel-browser.py` (in `tools/regression.py`) — 70 checks on real CC0 fixtures
