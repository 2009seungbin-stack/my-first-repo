...
with sync_playwright() as pw:
 ...
 page=mount(en,'/');ok('only qualified tools are promoted on home',page.locator('.feature-link').evaluate_all('ns=>ns.map(n=>n.dataset.action)')==['intent:compress']);page.keyboard.press('Control+k');page.locator('#toolSearch').fill('upscale');click(page,'kit-open:upscale');ok('catalog keeps the existing upscale workflow',page.locator('#emptyTitle').inner_text()=='Make your image bigger');page.close()
