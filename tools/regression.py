...
try:
    ...
    for suite in ['browser','recipes-browser','growth-browser','seo-browser','landings-browser','task-browser','studio-browser','studio-sprite-browser','studio-pack-browser','studio-tile-browser','studio-texture-browser','game-landing-browser','design-browser']:run(suite,[sys.executable,'tests/'+suite+'.py'])
finally:
