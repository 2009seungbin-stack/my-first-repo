...
S.ko.tile={drop:'타일셋 이미지를 여기에 놓으세요',dropHint:'격자 타일 시트 · 타일 크기를 추정해 순위로 보여줍니다',importLayout:'layout JSON 불러오기',sample:'샘플 타일셋',
 ...
 evidence:{separators:'구분선',repeatedEdges:'경계 반복',contentStops:'내용 끊김'},
 manual:'직접 지정',tileW:'타일 너비',tileH:'타일 높이',marginX:'바깥 여백 X',marginY:'바깥 여백 Y',spacingX:'간격 X',spacingY:'간격 Y',
 ...
 nearNote:'“거의 같음”은 픽셀 차이 임계값입니다. 사람이 보는 유사도가 아닙니다.',nearThreshold:'평균 픽셀 차이 허용치',
 ...
 count:'{n}장',runTemplate:'템플릿 PNG + JSON 다운로드',templateNote:'화가가 위에 덧그리는 안내용 이미지입니다. 각 칸의 번호·마스크는 layout JSON과 일치합니다.',
 paint:'칠하기',erase:'지우기',fillAll:'전체 채우기',clear:'비우기',randomFill:'무작위 채우기',seed:'시드',outside:'바깥도 지형으로 보기',gridLines:'격자선',size:'지형 격자 크기',
 ...
 seamTile:'검사할 타일',repeat:'반복 미리보기',diffH:'좌↔우 차이',diffV:'상↔하 차이',neighbour:'보통 이웃 줄',ratio:'{n}배',
 seamlessYes:'이어붙여도 이음새가 보이지 않습니다',seamlessNo:'이음새가 보입니다',
 heal:'이음새 없애기 미리보기',healNote:'그림을 실제로 바꿉니다(반 칸 이동 + 경계 혼합). 원본과 비교한 뒤 저장하세요.',healSave:'이음새 없앤 타일 저장',blend:'혼합 폭',
 matchWith:'이 타일과 맞춰보기',sides:{right:'오른쪽',left:'왼쪽',top:'위',bottom:'아래'},fits:'잘 맞습니다',notFit:'맞지 않습니다',
...
S.en.tile={drop:'Drop a tileset image here',dropHint:'A grid tile sheet · the tile size is measured and ranked, never forced',importLayout:'Load a layout JSON',sample:'Sample tileset',
 ...
 evidence:{separators:'separator lines',repeatedEdges:'repeated edges',contentStops:'content stops'},
 manual:'Set the grid by hand',tileW:'Tile width',tileH:'Tile height',marginX:'Outer margin X',marginY:'Outer margin Y',spacingX:'Spacing X',spacingY:'Spacing Y',
 ...
 nearNote:'"Near-identical" is a pixel-difference threshold, not a judgement of how similar they look.',nearThreshold:'Allowed mean pixel difference',
 ...
 count:'{n} tiles',runTemplate:'Download template PNG + JSON',templateNote:'Guide art to paint over. Each cell’s number and mask match the layout JSON exactly.',
 paint:'Paint',erase:'Erase',fillAll:'Fill all',clear:'Clear',randomFill:'Random fill',seed:'Seed',outside:'Treat outside as terrain',gridLines:'Grid lines',size:'Terrain grid size',
 ...
 seamTile:'Tile to check',repeat:'Repeat preview',diffH:'left ↔ right difference',diffV:'top ↔ bottom difference',neighbour:'ordinary neighbour lines',ratio:'{n}×',
 seamlessYes:'This tile repeats without a visible seam',seamlessNo:'The repeat shows a seam',
 heal:'Preview a seamless version',healNote:'This really does alter the art (half-tile offset + cross-blend). Compare with the original before saving.',healSave:'Save the seamless tile',blend:'Blend width',
 matchWith:'Match against tile',sides:{right:'right',left:'left',top:'top',bottom:'bottom'},fits:'fits',notFit:'does not fit',
...
S.ja.tile={drop:'タイルセット画像をここにドロップ',dropHint:'格子タイルシート · タイルサイズを実測して候補を順位付けします',importLayout:'layout JSONを読み込む',sample:'サンプルタイルセット',
 ...
 evidence:{separators:'区切り線',repeatedEdges:'境界の反復',contentStops:'内容の途切れ'},
 manual:'手入力で指定',tileW:'タイル幅',tileH:'タイル高',marginX:'外側余白 X',marginY:'外側余白 Y',spacingX:'間隔 X',spacingY:'間隔 Y',
 ...
 nearNote:'「ほぼ同じ」はピクセル差のしきい値です。見た目の類似度の判断ではありません。',nearThreshold:'許容する平均ピクセル差',
 ...
 count:'{n}枚',runTemplate:'テンプレートPNG + JSONをダウンロード',templateNote:'絵師が上から描くための下絵です。各セルの番号とマスクはlayout JSONと一致します。',
 paint:'描く',erase:'消す',fillAll:'全部塗る',clear:'消去',randomFill:'ランダムに塗る',seed:'シード',outside:'外側も地形として扱う',gridLines:'格子線',size:'地形グリッドの大きさ',
 ...
 seamTile:'検査するタイル',repeat:'繰り返しプレビュー',diffH:'左↔右の差',diffV:'上↔下の差',neighbour:'通常の隣接行',ratio:'{n}倍',
 seamlessYes:'繰り返しても継ぎ目は見えません',seamlessNo:'継ぎ目が見えます',
 heal:'継ぎ目をなくしたプレビュー',healNote:'絵を実際に変更します（半タイル移動＋境界のブレンド）。元と比べてから保存してください。',healSave:'継ぎ目のないタイルを保存',blend:'ブレンド幅',
 matchWith:'合わせるタイル',sides:{right:'右',left:'左',top:'上',bottom:'下'},fits:'よく合います',notFit:'合いません',
