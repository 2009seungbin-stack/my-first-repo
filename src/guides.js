...
export const GUIDES=Object.freeze([
 ...
 {slug:"pixijs-8-spritesheet-animation",section:"sprites",engines:["pixi"],updated:"2026-09-24",tools:["sprite-sheet-maker","sprite-slicer","sprite-animation-preview","sprite-pivot-editor"],open:{ws:"sprite"},related:["phaser-sprite-sheet-atlas-animation","pixel-art-crisp-in-browser-phaser-pixi","sprite-sheet-vs-texture-atlas","hitboxes-pivots-2d-animation"],tested:["PixiJS 8.21.0"],
  title:{ko:"PixiJS 8 스프라이트시트 애니메이션 (AnimatedSprite)",en:"PixiJS 8 spritesheet animation: JSON, AnimatedSprite, pixel art",ja:"PixiJS 8 スプライトシートとAnimatedSpriteの使い方"},
  description:{ko:"PixiJS 8에서 스프라이트시트 JSON을 Assets.load로 불러와 AnimatedSprite로 재생하고, 'nearest'로 도트를 선명하게, @2x meta.scale을 바르게 쓰는 방법입니다.",en:"Load a spritesheet JSON with Assets.load in PixiJS 8, play it with AnimatedSprite, keep pixel art sharp with scaleMode 'nearest' and get @2x meta.scale right.",ja:"PixiJS 8でスプライトシートJSONをAssets.loadで読み込み、AnimatedSpriteで再生する方法。ドット絵をnearestでくっきりさせ、@2xのmeta.scaleも正しく扱います。"}},
 {slug:"godot-4-pixel-art-blurry-jitter",section:"pixel-art",engines:["godot"],updated:"2026-09-24",tools:["pixel-perfect-checker","pixel-lab","sprite-animation-preview"],open:{tool:"pixel-perfect-checker"},related:["godot-4-sprite-sheet-animation","unity-pixel-art-blurry-pixel-perfect","pixel-art-crisp-in-browser-phaser-pixi","fix-ai-generated-pixel-art"],tested:["Godot 4.7.2"],
  title:{ko:"Godot 4 도트 흐림·떨림 해결: 필터, 스트레치, 스냅",en:"Godot 4 Pixel Art Blurry or Jittering? Filter, Stretch, Snap",ja:"Godot4 ドット絵がぼやける・ガタつく時の設定"},
  description:{ko:"Godot 4.7에서 픽셀 아트가 흐리거나 떨릴 때: Nearest 필터, viewport 스트레치와 정수 배율, 픽셀 스냅, 카메라와 물리 보간까지 실제로 확인한 설정입니다.",en:"Fix blurry, shimmering or jittering pixel art in Godot 4.7: Nearest filter, viewport stretch with integer scale, pixel snap, camera and physics interpolation, tested.",ja:"Godot 4.7でドット絵がぼやける・ガタつく原因と対策。Nearestフィルター、viewportと整数倍スケール、ピクセルスナップ、カメラと物理補間を実機で確認。"}},
 {slug:"unity-pixel-art-blurry-pixel-perfect",section:"pixel-art",engines:["unity"],updated:"2026-09-24",tools:["pixel-perfect-checker","pixel-lab","pixel-art-cleanup"],open:{tool:"pixel-perfect-checker"},related:["godot-4-pixel-art-blurry-jitter","pixel-art-crisp-in-browser-phaser-pixi","unity-6-slice-sprite-sheet-animation","tile-seams-texture-bleeding-padding-extrude"],tested:["Unity 6000.5.3f1"],
  title:{ko:"유니티 도트 흐림 해결: 임포트 설정과 Pixel Perfect Camera",en:"Unity Pixel Art Blurry? Import Settings and Pixel Perfect Camera",ja:"Unity ドット絵がぼやける原因と Pixel Perfect Camera"},
  description:{ko:"Unity 6에서 도트가 흐릿하게 보이는 원인과 해결법. Point 필터, 압축 없음, Max Size, 밉맵, PPU, Pixel Perfect Camera, 프리셋까지 실제 렌더로 확인합니다.",en:"Fix blurry pixel art in Unity 6: Point filter, no compression, Max Size, mip maps, one Pixels Per Unit, Pixel Perfect Camera, presets and Sprite Atlas settings.",ja:"Unity 6 でドット絵がぼやける原因と直し方。Point フィルター、圧縮なし、Max Size、ミップマップ、PPU、Pixel Perfect Camera、プリセットを実際の描画で確認します。"}},
 {slug:"palette-swap-sprites",section:"pixel-art",engines:["godot","unity","phaser","pixi"],updated:"2026-09-24",tools:["pixel-lab","palette-swap-ramp","palette-extractor","palette-swap"],open:{tool:"pixel-lab"},related:["fix-ai-generated-pixel-art","godot-4-pixel-art-blurry-jitter","pixel-art-crisp-in-browser-phaser-pixi","unity-pixel-art-blurry-pixel-perfect"],tested:["Godot 4.7.2","Unity 6000.5.3f1","Phaser 3.90","Phaser 4.2","PixiJS 8.21"],
  title:{ko:"스프라이트 팔레트 스왑: 셰이더와 색상 변형 만들기",en:"Palette Swap Sprites: Index Map Shaders and Baked Variants",ja:"スプライトのパレットスワップ:シェーダーと色違いの作り方"},
  description:{ko:"적 등급·팀 색상용 팔레트 스왑. Godot 4와 Unity 6 인덱스 맵 셰이더, Phaser·PixiJS 색상 변형 굽기, 필터링 함정까지 실제 엔진에서 검증한 방법입니다.",en:"Palette-swap sprites for enemy tiers and team colours: an index-map shader for Godot 4 and Unity 6, baked variants for Phaser and PixiJS, and the filtering traps.",ja:"敵のランク違いやチームカラーのためのパレットスワップ。Godot 4とUnity 6のインデックスマップシェーダー、Phaser・PixiJSでの色違い生成、フィルタリングの落とし穴を解説します。"}},
 ...
 {slug:"2d-normal-maps-lighting-godot-unity",section:"lighting",engines:["godot","unity"],updated:"2026-09-24",tools:["texture-lab","texture-map","normal-map-converter"],open:{tool:"texture-lab"},related:["opengl-vs-directx-normal-maps","godot-4-pixel-art-blurry-jitter","sprite-sheet-vs-texture-atlas","unity-pixel-art-blurry-pixel-perfect"],tested:["Godot 4.7.2","Unity 6000.5.3f1"],
  title:{ko:"2D 노멀맵과 조명: Godot 4·Unity 6 스프라이트 라이팅",en:"2D Normal Maps and Lighting in Godot 4 and Unity 6",ja:"2Dノーマルマップとライティング：Godot 4・Unity 6"},
  description:{ko:"Godot 4 CanvasTexture·PointLight2D 높이·그림자와 Unity 6 URP _NormalMap·Light 2D로 스프라이트에 노멀맵 조명을 적용하는 방법. 도트 설정까지 실제 실행으로 확인했습니다.",en:"Light 2D sprites with normal maps: Godot 4 CanvasTexture, PointLight2D height and shadows, Unity 6 URP _NormalMap and Light 2D. Pixel-art settings, tested.",ja:"Godot 4のCanvasTexture・PointLight2Dの高さ・影と、Unity 6 URPの_NormalMap・Light 2Dでスプライトにノーマルマップの光を当てる手順。ドット絵設定も実機で確認。"}},
 ...
 {slug:"bitmap-font-sdf-msdf-game-ui",section:"ui",engines:["godot","unity","phaser","pixi"],updated:"2026-09-24",tools:["bitmap-font","ui-lab","missing-glyph-checker"],open:{tool:"bitmap-font"},related:["cjk-font-atlas-localization","pixel-art-crisp-in-browser-phaser-pixi","unity-pixel-art-blurry-pixel-perfect","nine-slice-ui-godot-unity-phaser"],tested:["Godot 4.7.2","Phaser 3.90.0","Phaser 4.2.1","PixiJS 8.21.0"],
  title:{ko:"게임 UI 폰트: 비트맵 폰트 vs SDF vs MSDF",en:"Bitmap Font vs SDF vs MSDF for Game UI (Godot, Unity, Web)",ja:"ゲームUIフォント：ビットマップ・SDF・MSDFの違い"},
  description:{ko:"게임 텍스트에 비트맵 폰트(BMFont)·SDF·MSDF를 언제 쓰는지, 도트 폰트를 선명하게 쓰는 법, Godot 4.7·Unity 6·Phaser·PixiJS 8 설정을 실제 엔진으로 검증했습니다.",en:"When to use a BMFont bitmap font, SDF or MSDF for game text, crisp pixel fonts, and exact settings for Godot 4.7, Unity 6, Phaser and PixiJS 8, tested in engines.",ja:"ゲームのテキストにビットマップフォント・SDF・MSDFをどう使い分けるか、ドットフォントをくっきり表示する設定を、Godot 4.7・Unity 6・Phaser・PixiJS 8で検証しました。"}}
]);
